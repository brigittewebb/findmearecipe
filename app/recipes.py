...
def retrieve_recipes_by_ingredients(search_criteria, cuisine, diet, intolerances, dish_type, maxReadyTime, sort, number, fillIngredients):
    ...
    url_parameters = {"query":search_criteria,"cuisine":cuisine,"diet":diet,"intolerances":intolerances,"type":dish_type,"maxReadyTime":maxReadyTime,"sort":sort,"number":number,"fillIngredients":fillIngredients}
